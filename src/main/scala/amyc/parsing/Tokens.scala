...
object Tokens {
  ...
  final case class PrimTypeToken(value: String)
      extends Token // e.g. primitive type "Int"
  final case class IntLitToken(value: Int)
      extends Token // e.g. integer literal "123"
  final case class CharLitToken(value: String) extends Token
